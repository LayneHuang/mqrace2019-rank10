...
//        }
    ...
    public List<Message> easyFind2(long minT, long maxT, long minA, long maxA) {
        ...
        for (int i = l; i <= r; ++i) {
            ...
            byte[][] bodyList = HelpUtil.readBody2(posBs[sIdx], tMsgAmount);
...
//        long distance = PretreatmentHolder.getIns().distance;
        int btPos = HelpUtil.getPosition2(minA);
        int tpPos = HelpUtil.getPosition2(maxA);
